...
but also to cover the following topics:
    ...
    - > How ring removal methods work; pros and cons of each method; how to use
      them efficiently; and how to improve them.
    - > Applications of the methods.

**Source code:**
    - https://github.com/nghia-vo/sarepy
...
is a complete package for processing tomographic data. It is
...
3.  Nghia T. Vo, Robert C. Atwood, Michael Drakopoulos, and Thomas Connolley,
    "Data processing methods and data acquisition for samples larger than the
    field of view in parallel-beam tomography," Opt. Express 29, 17849-17874
    (2021); https://doi.org/10.1364/OE.418448.
